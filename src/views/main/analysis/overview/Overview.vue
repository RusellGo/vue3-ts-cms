<template>
  <div class="overview">
    ...
    <ru-card title="技术栈">
      <ru-text-link :text-arrs="technologyStacks" />
      <ru-descriptions
        title="生产环境依赖"
        :column="2"
    ...
    <ru-card title="项目结构">
      <div class="c-left">
        <ru-code language="bash" :code="projectDir" />
      </div>
    </ru-card>
    <ru-card title="项目规范">
      <ru-descriptions
...
import RuDescriptions from '@/base-ui/descriptions';
import RuTextLink from '@/base-ui/text-link';
import RuCode from '@/base-ui/code';
